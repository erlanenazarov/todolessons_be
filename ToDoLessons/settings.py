"""
Django settings for ToDoLessons project.
...
from utils.dates import DATE_FORMAT, TIME_FORMAT, DATE_TIME_FORMAT
...
WSGI_APPLICATION = 'ToDoLessons.wsgi.application'
...
ACCESS_TOKEN_LIFE_TIME = env.int('ACCESS_TOKEN_LIFE_TIME', default=5)

SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timezone.timedelta(minutes=ACCESS_TOKEN_LIFE_TIME),
